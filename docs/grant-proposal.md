...
| M5        | Real refund path: drive the receiving anchor's SEP-31 refund flow instead of escalating every unrecoverable settlement to a manual `held`                                                                                                                          | ROADMAP Phase 2 (reopened — not implemented today)                                    | `[DRAFT: ~$4,000]` | `[DRAFT: ~4-6 weeks]`                                                  |
| **Total** |                                                                                                                                                                                                                                                                    |                                                                                       | `[DRAFT: ~$9,000]` |                                                                        |
